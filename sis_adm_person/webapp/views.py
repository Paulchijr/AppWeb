...
def mostrar_personas (recuest):
    contador_persona=Persona.objects.count()
    ...
    datos={"cantidad":contador_persona, "personas": personas, 'nombres_personas':nombres_personas}
    pagina = loader.get_template('personas.html')

    return HttpResponse(pagina.render(datos, recuest))